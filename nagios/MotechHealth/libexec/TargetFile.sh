...
/opt/sendEmail/sendEmail -f motechnagios@ggn.rcil.gov.in -s email.ggn.rcil.gov.in -t saurabh.tamrakar@in.bbcmediaaction.org,pnagpal@grameenfoundation.in,Gur_PSS_Grameen_L1@aricent.com,Gur_PSS_Grameen_L2@aricent.com,fhuster@grameenfoundation.org,bbcsupport@imimobile.com,ankit2.shukla@aricent.com,mukesh.roy@aricent.com,sara.chamberlain@in.bbcmediaaction.org,Motech-support@beehyv.in,motech-support@beehyv.in -o message-file=/tmp/target_output.html -u "MOTECH TargetFile Notification">/dev/null
